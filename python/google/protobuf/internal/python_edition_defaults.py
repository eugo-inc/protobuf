...
# In bazel-based build flow, this is dynamically generated by using `PROTO2...2023` editions range.
# However, it involves building intermediate C++ executable just for octal encoding.
# We've decided instead to embed this value based on one from the latest PyPi-distributed version.